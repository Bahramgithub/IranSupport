...
PROMPT_TEMPLATES = {
    ...
    "fa": {
        ...
        "برنامه ریزی امنیتی": "من نگران امنیت و سلامت روانی خودم هستم. میتوانید به من در ایجاد یک برنامه امنیتی کمک کنید؟",
...
def main():
    ...
    with col2:
        ...
        if selected_template != custom_label:
            ...
            st.text_area(
                "Template Preview" if lang_code == "en" else "پیش نمایش قالب",
